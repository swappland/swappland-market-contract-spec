 ...
 *
 */
export type  = AccountId | AccountIds | BidHistoryLength | TokenId | NftBuyOffer | U128 | ContractTokenId | U64 | Limit | MarketTokenType | BooleanVyG3AETh | TokenIds | NullQu0Arl1F | Booleans | Sale | Sales | StorageBalanceBoundsObject | StorageBalance | UnorderedSetOfBooleanVyG3AETheht2BVDp;
...
export type RemoveSale = (nft_contract_id: AccountId, token_id: TokenId) => Promise<NullQu0Arl1F>;
export type GetSale = (nft_contract_token: ContractTokenId) => Promise<Sale>;
...
export class SwapplandMarket {
   ...
   */
  // tslint:disable-next-line:max-line-length
  public remove_sale(nft_contract_id: AccountId, token_id: TokenId, options?: ChangeMethodOptions): RTRemoveSale { 
   ...
   */
  // tslint:disable-next-line:max-line-length
  public get_sale(nft_contract_token: ContractTokenId): RTGetSale { 
