...
export interface NftBuyOffer {
  sale_id: SaleId;
  offer_approval_id: ApprovalId;
  offer_nft_contract_id: AccountId;
  offer_nft_token_id: TokenId;
  [k: string]: any;
}
...
export type MarketTokenType = string;
 ...
 *
 */
export type  = AccountId | AccountIds | BidHistoryLength | TokenId | NftBuyOffer | SaleConditions | SaleItem | ApprovalId | U128 | SaleId | U64 | Limit | MarketTokenType | BooleanVyG3AETh | TokenIds | NullQu0Arl1F | Booleans | Sale | Sales | StorageBalanceBoundsObject | StorageBalance | UnorderedSetOfBooleanVyG3AETheht2BVDp;
...
export type NftList = (sale_conditions: SaleConditions, sale_item: SaleItem, sale_approval_id?: ApprovalId) => Promise<NullQu0Arl1F>;
...
export type GetSalesByNftTokenType = (token_type: MarketTokenType, from_index: U64, limit: Limit) => Promise<Sales>;
...
export type GetSupplyByNftTokenType = (token_type: MarketTokenType) => Promise<U64>;
...
export type StorageWithdraw = (token_ids: TokenIds, amount: U128) => Promise<StorageBalance>;
   ...
   */
  // tslint:disable-next-line:max-line-length
  type GTGetSalesByNftTokenType = [...Parameters<GetSalesByNftTokenType>, ChangeMethodOptions?]
  type RTGetSalesByNftTokenType = ReturnType<GetSalesByNftTokenType>
   ...
   */
  // tslint:disable-next-line:max-line-length
  type GTGetSupplyByNftTokenType = [...Parameters<GetSupplyByNftTokenType>, ChangeMethodOptions?]
  type RTGetSupplyByNftTokenType = ReturnType<GetSupplyByNftTokenType>
...
export class SwapplandMarket {
   ...
   */
  // tslint:disable-next-line:max-line-length
  public nft_list(sale_conditions: SaleConditions, sale_item: SaleItem, sale_approval_id?: ApprovalId): RTNftList { 
    ...
    return (this.contract as any).nft_list(paramByName) as RTNftList 
   ...
   */
  // tslint:disable-next-line:max-line-length
  public get_sales_by_nft_token_type(token_type: MarketTokenType, from_index: U64, limit: Limit): RTGetSalesByNftTokenType { 
    //return this.request("get_sales_by_nft_token_type", params);
    const paramNames:string[] = [  
      "token_type", 
      "from_index", 
      "limit",
    ...
    const paramByName = _.zipObject(paramNames, args);
    if (options && Object.keys(options).length) {
    return (this.contract as any).get_sales_by_nft_token_type({args: paramByName, ...options}) as RTGetSalesByNftTokenType 
    }

    return (this.contract as any).get_sales_by_nft_token_type(paramByName) as RTGetSalesByNftTokenType 
   ...
   */
  // tslint:disable-next-line:max-line-length
  public get_supply_by_nft_token_type(token_type: MarketTokenType): RTGetSupplyByNftTokenType { 
    //return this.request("get_supply_by_nft_token_type", params);
    const paramNames:string[] = [  
      "token_type",
    ]
    const arrArgs = Array.from(arguments); 
    ...
    const paramByName = _.zipObject(paramNames, args);
    if (options && Object.keys(options).length) {
    return (this.contract as any).get_supply_by_nft_token_type({args: paramByName, ...options}) as RTGetSupplyByNftTokenType 
    }

    return (this.contract as any).get_supply_by_nft_token_type(paramByName) as RTGetSupplyByNftTokenType 
