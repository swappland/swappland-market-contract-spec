 ...
 *
 */
export type  = AccountId | AccountIds | TokenId | NftBuyOffer | SaleArgs | SaleItem | ApprovalId | U128 | SaleId | U64 | Limit | BooleanVyG3AETh | TokenIds | NullQu0Arl1F | Booleans | Sale | Sales | NumberHo1ClIqD | StorageBalanceBoundsObject | StorageBalance | UnorderedSetOfBooleanVyG3AETheht2BVDp;
export type New = (owner_id: AccountId, fee_account: AccountId, ft_token_ids?: AccountIds) => Promise<NullQu0Arl1F>;
...
export type GetSalesByContractTokenId = (contract_id: AccountId, token_id: TokenId) => Promise<Sales>;
...
export type StorageWithdraw = (token_ids: TokenIds, amount: U128) => Promise<StorageBalance>;
   ...
   */
  // tslint:disable-next-line:max-line-length
  type GTGetSalesByContractTokenId = [...Parameters<GetSalesByContractTokenId>, ChangeMethodOptions?]
  type RTGetSalesByContractTokenId = ReturnType<GetSalesByContractTokenId>
...
export class SwapplandMarket {
  ...
  constructor(options: Options) {
    ...
    const viewMethods:string[] = [
      ...
      "get_sales_by_contract_token_id",
   ...
   */
  // tslint:disable-next-line:max-line-length
  public new(owner_id: AccountId, fee_account: AccountId, ft_token_ids?: AccountIds, options?: ChangeMethodOptions): RTNew { 
  ...
  /**
   * Get sales by contract and token id
   * 
   */
  // tslint:disable-next-line:max-line-length
  public get_sales_by_contract_token_id(contract_id: AccountId, token_id: TokenId): RTGetSalesByContractTokenId { 
    //return this.request("get_sales_by_contract_token_id", params);
    const paramNames:string[] = [  
      "contract_id", 
      "token_id",
    ]
    ...
    const paramByName = _.zipObject(paramNames, args);
    if (options && Object.keys(options).length) {
    return (this.contract as any).get_sales_by_contract_token_id({args: paramByName, ...options}) as RTGetSalesByContractTokenId 
    }

    return (this.contract as any).get_sales_by_contract_token_id(paramByName) as RTGetSalesByContractTokenId 
